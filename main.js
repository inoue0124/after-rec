...
var FileURL = 'mp4/' + task_name + '/num_of_files';
var num_of_files;
var order_index;
var order_ary;
...
$(function(){
    initializeWaveforms();
    $('#model-button').click(function(e) { videoplay(e); return false; });
    ...
    $('#video-panel').html('<video id="video" width="800px" height="450px" src="mp4/' + task_name + '/' + task_name + '_' + q_num + '.mp4"></video>');
});
...
function initializeWaveforms() {
    ...
    // �~B��~C��~B��~C~J�~C�波形�~V�~B~Y�~L�~F�~G��~P~F
...
function stopRecording() {
    ...
    recorder && recorder.exportWAV(function(blob) {
        ...
        $('#model-button').attr('disabled', false);
        $('#start').attr('disabled', false);
        recorded = true;
        var fd = new FormData();
...
function submitButtonClicked(e) {
    ...
    if (q_num == num_of_files) {
     ...
     if (String(task_prog) == order_ary.length){
       var URL = 'https://www.gavo.t.u-tokyo.ac.jp/~inoue0124/after-rec/finish.php';
    ...
    var URL = 'https://www.gavo.t.u-tokyo.ac.jp/~inoue0124/after-rec/main.php?u=' + user_id + '&p=' + String(task_prog) + '&t=' + task_name + '&n=' + String(q_num);
    window.location.href = URL;
 }
}
